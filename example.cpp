 ...
 */
Example::Example(QWidget *parent, Qt::WFlags f) : QWidget(parent, f)
{
...
void Example::on_StartButton_clicked()
{
	rotate->start();
}

void Example::on_StopButton_clicked()
{
	rotate->stop();
}

void Example::on_RestoreButton_clicked()
{
	rotate->restore();
}
